    ...
    @include('product.categories')
        ...
        <section id="content">
            <div class="content-wrap">
                <div class="container clearfix">
                    <div class="col_desc">
                        <p>Thế Giới Điện Máy: tại số Số 1 Ngõ 214/23 Đường Nguyễn Xiển, Quận Thanh Xuân, Hà Nội&nbsp;là nơi phân phối lớn nhất các sản phẩm ĐIỀU HOÀ, MÁY LỌC NƯỚC NHẬT NỘI ĐỊA, Nhật bãi tại Hà Nội&nbsp;</p>
{{--                        <p>ĐIỀU HOÀ NỘI ĐỊA, Nhật&nbsp;bãi chúng tôi phân phối là dòng Toshiba , Panasonic , Sharp , Mitsu, Hitachi với công nghệ cao nhất hiện nay với giá tốt nhất</p>--}}
{{--                        <p><span><span dir="auto" class="style-scope yt-formatted-string">🚄 youtube hướng dẫn sp ( tìm từ khóa - Hàng nhật Tuấn Hà ):&nbsp;--}}
{{--                        <p><span><span dir="auto" class="style-scope yt-formatted-string">🏠 Web kinh nghiệm sửa lỗi và đánh giá sản phẩm :&nbsp;--}}
{{--                        <p><span><span dir="auto" class="style-scope yt-formatted-string">​</span><span dir="auto" class="style-scope yt-formatted-string">&nbsp;_______________</span></span></p>--}}
                        ...
                        <p><span><span dir="auto" class="style-scope yt-formatted-string">Hotline: Kinh doanh : 0972 498 333 - Kỹ thuật: 0845 44 1111</span></span></p>
